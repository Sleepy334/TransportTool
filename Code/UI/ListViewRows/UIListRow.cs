...
namespace PublicTransportInfo.UI.ListViewRows
{
    public abstract class UIListRow<T> : UIPanel, IUIFastListRow
    {
        ...
        protected bool m_bAfterStart = false;
        private object? m_data = null;
        private bool m_bFullRowSelect = false;
        
        // Live toltip support
        protected UIComponent? m_tooltipComponent = null;
        ...
        public override void Start()
        {
            ...
            canFocus = true;
            isInteractive = true;
            width = parent.width - UIListView.iSCROLL_BAR_WIDTH;
            height = UIListView.iROW_HEIGHT;
        ...
        public virtual void Display(int index, object data, bool isRowOdd)
        {
            ...
            else
            {
                ...
                foreach (UIComponent component in components)
                {
                    if (component is UILabel label)
                    {
                        label.textColor = GetTextColor(component, false);
                    }
                }
            }
        }
        ...
        { 
            return m_tooltipComponent != null && 
                    m_tooltipComponent.tooltipBox is not null &&
        ...
        public virtual void Enabled(object data)
        {
        }
        ...
        protected virtual void OnTooltipEnter(UIComponent component, UIMouseEventParameter eventParam)
        {
            ...
            if (data is not null && component is not null)
            {
                ...
                if (sTooltip.Length > 0)
                {
                    if (component is UILabelLiveTooltip)
                    {
                        ((UILabelLiveTooltip)component).SetTooltip(sTooltip);
                    }
                    else
                    {
        ...
        protected virtual void OnMouseEnter(UIComponent component, UIMouseEventParameter eventParam)
        {
        ...
        protected virtual void OnMouseLeave(UIComponent component, UIMouseEventParameter eventParam)
        {
