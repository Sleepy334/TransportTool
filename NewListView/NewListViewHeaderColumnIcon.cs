...
{
    public class NewListViewHeaderColumnIcon : NewListViewHeaderColumnBase
    {
        private UIPanel? m_pnlIcon = null;
        private UILabel? m_lblIcon = null;
        private UILabel? m_lblIconSort = null;

        public NewListViewHeaderColumnIcon(NewListViewRowComparer.Columns eColumn, UIComponent parent, string sText, string sTooltip, int iWidth, int iHeight, UIHorizontalAlignment oTextAlignment, UIAlignAnchor oAncor, OnListViewColumnClick eventCallback) :
