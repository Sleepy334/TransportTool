...
{
    public class NewListViewRowColumn
    {
        private UILabel? m_lblColumn = null;
        private OnGetColumnTooltip? m_GetColumnTooltip = null;
        private NewListViewRowComparer.Columns m_eColumn;
        private OnColumnClick? m_columnClickCallback = null;

        public delegate void OnColumnClick(NewListViewRowColumn oColumn);

        public delegate string OnGetColumnTooltip(NewListViewRowColumn oColumn);

        public static NewListViewRowColumn Create(NewListViewRowComparer.Columns eColumn, UIComponent parent, string sText, string sTooltip, float fTextScale, int iWidth, int iHeight, UIHorizontalAlignment oTextAlignment, UIAlignAnchor oAncor, OnColumnClick eventClickCallback, OnGetColumnTooltip getColumnTooltip)
        {
            NewListViewRowColumn oColumn = new NewListViewRowColumn();
        ...
        private void Setup(NewListViewRowComparer.Columns eColumn, UIComponent parent, string sText, string sTooltip, float fTextScale, int iWidth, int iHeight, UIHorizontalAlignment oTextAlignment, UIAlignAnchor oAncor, OnColumnClick eventClickCallback, OnGetColumnTooltip getColumnTooltip)
        {
            m_eColumn = eColumn;
